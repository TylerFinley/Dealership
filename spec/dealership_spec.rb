...
describe(Dealership) do
    ...
    describe('#name') do
        it("returns the name of the dealership") do
            test_dealership = Dealership.new("Tyler's Used Cars")
            expect(test_dealership.name()).to(eq("Tyler's Used Cars"))
        end
    end
    ...
    describe(".clear") do
        it("empties out all of the saved dealerships") do
            Dealership.new("Tyler's Used Cars").save()
            Dealership.clear()
            expect(Dealership.all()).to(eq([]))
        end
    end
    ...
    describe(".find") do
        it("returns a dealership by its id number") do
            test_dealership = Dealership.new("Tyler's Used Cars")
            test_dealership.save()
            test_dealership2 = Dealership.new("Leah's Cars")
